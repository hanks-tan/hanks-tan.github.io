...
var kriging = function() {
	...
	//update by txb,2019年2月19日17:42:55,增加最大值最小值属性
	variogram.tMax = variogram.tMax = variogram.t.max()
	variogram.tMin = variogram.tMin = variogram.t.min()
	if(tMax){
		variogram.tMax = tMax
	};
	if(tMax){
	...
	A.xlim = xlim
	A.ylim = ylim
	A.zlim = [variogram.tMin, variogram.tMax]
	A.width = width
	return A
    }
